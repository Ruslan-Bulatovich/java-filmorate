...
@Slf4j
@Component
public class UserDbStorage implements UserStorage, StorageDb {
    ...
    public User addUser(User user) {
        ...
        user.setId((long) Objects.requireNonNull(generatedId.getKey()).intValue());
    ...
    public Optional<User> getUserById(Long id) {
        ...
        User user = queryForObjectOrNull(sqlQuery, this::makeUser, id);
        if (user == null) {
